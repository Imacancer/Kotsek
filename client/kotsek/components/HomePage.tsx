...
export default function HomePage() {
  ...
  useEffect(() => {
    // Set window height once the component mounts in the browser
    ...
    <div className="relative">
      ...
      >
        <div
          className="absolute inset-0 w-full h-full"
          style={{
            transform: windowHeight
              ? `translateY(${(scrollY - windowHeight) * 0.3}px)`
              : "translateY(0)",
            willChange: "transform",
          }}
        >
      ...
      >
        <div
          ...
          style={{
            transform: windowHeight
              ? `translateY(${(scrollY - windowHeight * 2) * 0.4}px)`
              : "translateY(0)",
            willChange: "transform",
          }}
        >
