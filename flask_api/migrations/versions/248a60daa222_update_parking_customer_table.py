...
Revision ID: 248a60daa222
Revises: fda50d547a41
Create Date: 2025-05-11 13:15:54.280114
...
revision: str = '248a60daa222'
down_revision: Union[str, None] = 'fda50d547a41'
...
def upgrade() -> None:
    ...
    op.add_column('parking_customers', sa.Column('email', sa.String(length=100), nullable=False))
